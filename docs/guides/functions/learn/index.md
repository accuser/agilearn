...
1. **[Defining functions](01-defining-functions.ipynb)** — `def`, parameters, return values, default arguments.
2. **[Lambda expressions](02-lambda-expressions.ipynb)** — concise anonymous functions.
3. **[Type hints](03-type-hints.ipynb)** — annotating function signatures for clarity and tooling.
4. **[Docstrings](04-docstrings.ipynb)** — documenting functions effectively.
5. **[Scope and closures](05-scope-and-closures.ipynb)** — how Python resolves names, and how closures capture state.
6. **[`*args` and `**kwargs`](06-args-and-kwargs.ipynb)** — handling variable numbers of arguments.
7. **[Decorators](07-decorators.ipynb)** — creating and applying decorators.
